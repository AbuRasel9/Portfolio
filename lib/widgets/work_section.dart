  ...
  Widget build(BuildContext context) {
    ...
    final projects = [
      _ProjectData(
        ...
        imagePath: 'assets/images/flights_nepal_logo.png',
        isAsset: true,
        ...
        tags: ['Flutter', 'Provider','Firebase', 'REST APIs', 'Payment Gateway'],
      ...
      _ProjectData(
        ...
        imagePath: 'assets/images/rupse_icon.png',
        isAsset: true,
      ...
      _ProjectData(
        ...
        imagePath: 'assets/images/ecormmer_logo.png',
        isAsset: true,
...
class _ProjectCardState extends State<_ProjectCard> {
  ...
  Widget build(BuildContext context) {
    ...
    return MouseRegion(
      ...
      child: AnimatedContainer(
        ...
        margin: EdgeInsets.only(bottom: widget.isTwoColumn ? 0 : 32),
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: _hovered
                ? project.tagColor.withValues(alpha: 0.5)
          ...
          boxShadow: [
            BoxShadow(
              color: _hovered
                  ? project.tagColor.withValues(alpha: 0.12)
        ...
        child: ClipRRect(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                // Top Row: Small Image & Title Area
                Row(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    // Small Image Box
  ...
  Widget _buildSmallImage() {
    final project = widget.project;
    const double size = 90.0; // Small size as requested
      ...
      child: project.isAsset
          ...
          : CachedNetworkImage(
              ...
              errorWidget: (ctx, url, e) => const Center(
                child: Icon(Icons.image_not_supported, color: Colors.white24, size: 20),
              ),
            ),
    );
